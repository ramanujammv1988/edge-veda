...
must_haves:
  truths:
    - "Test program loads a GGUF model successfully"
    - "Test program generates coherent text from a prompt"
    - "Performance exceeds 10 tokens/second on test machine"
...
<success_criteria>
1. Test program loads model successfully
2. Test program generates coherent text
3. Performance >= 10 tok/sec on development machine
