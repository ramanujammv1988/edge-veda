...
must_haves:
  truths:
    - "Memory stats polling allows SDK to respond to iOS memory pressure (R3.3)"
  ...
  artifacts:
    - path: "flutter/lib/src/edge_veda_impl.dart"
      provides: "Memory pressure monitoring via polling (getMemoryStats, isMemoryPressure)"
      contains: "getMemoryStats"
    - path: "flutter/lib/edge_veda.dart"
      provides: "Clean public API exports"
      exports: ["EdgeVeda", "EdgeVedaConfig", "GenerateOptions", "GenerateResponse", "ModelManager", "ModelInfo", "MemoryStats"]
  key_links:
    - from: "flutter/lib/src/edge_veda_impl.dart"
      to: "ev_get_memory_usage"
      via: "FFI bindings for memory stats polling"
      pattern: "evGetMemoryUsage"
---
