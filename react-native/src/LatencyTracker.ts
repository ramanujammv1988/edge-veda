/**
 * Edge Veda SDK - LatencyTracker
 * Thread-safe sliding window latency tracker for inference timing.
 *
 ...
 *
 * In React Native, JavaScript is single-threaded so no mutex is needed,
 * but the API matches Swift/Kotlin for consistency.
 */
